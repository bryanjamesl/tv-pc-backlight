...
# constants - # 24K ohms worth of restiors to 3.3v VCC (common anode RGB) 
led_r = Pin(18, Pin.OUT)                  # red lead on pin 18 
led_g = Pin(20, Pin.OUT)                  # green on pin 20 (skipped 19, easier to solder)
led_b = Pin(21, Pin.OUT)                  # blue on pin 21
